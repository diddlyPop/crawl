...
{ JOB_ARCANE_MARKSMAN, {
    "AM", "Arcane Marksman",
    2, 5, 5,
    { SP_FORMICID, SP_DEEP_ELF, SP_KOBOLD, SP_SPRIGGAN, SP_TROLL, SP_CENTAUR, SP_DUGONG_OVERLORD, },
...
{ JOB_CONJURER, {
    "Cj", "Conjurer",
    0, 7, 5,
    { SP_DEEP_ELF, SP_NAGA, SP_TENGU, SP_BASE_DRACONIAN, SP_DEMIGOD, SP_DUGONG_OVERLORD, },
...
{ JOB_EARTH_ELEMENTALIST, {
    ...
    { SP_DEEP_ELF, SP_DEEP_DWARF, SP_SPRIGGAN, SP_GARGOYLE, SP_DEMIGOD,
      SP_GHOUL, SP_OCTOPODE, SP_DUGONG_OVERLORD, },
...
{ JOB_ICE_ELEMENTALIST, {
    ...
    { SP_DEEP_ELF, SP_MERFOLK, SP_NAGA, SP_BASE_DRACONIAN, SP_DEMIGOD,
      SP_GARGOYLE, SP_DUGONG_OVERLORD, },
    { "robe", "book of Frost" },
    WCHOICE_NONE,
...
{ JOB_MONK, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_TROLL, SP_CENTAUR, SP_MERFOLK,
      SP_GARGOYLE, SP_DEMONSPAWN, SP_DUGONG_OVERLORD, },
    { "robe" },
    WCHOICE_PLAIN,
