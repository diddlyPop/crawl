...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_DUGONG_OVERLORD,    SK_AXES,           -1),
    APT(SP_DUGONG_OVERLORD,    SK_MACES_FLAILS,   -1),
    APT(SP_DUGONG_OVERLORD,    SK_POLEARMS,       -1),
    APT(SP_DUGONG_OVERLORD,    SK_STAVES,         -1),
    APT(SP_DUGONG_OVERLORD,    SK_SLINGS,         -1),
    APT(SP_DUGONG_OVERLORD,    SK_BOWS,           -1),
    APT(SP_DUGONG_OVERLORD,    SK_CROSSBOWS,      -1),
    APT(SP_DUGONG_OVERLORD,    SK_THROWING,       -1),
    APT(SP_DUGONG_OVERLORD,    SK_ARMOUR,         -2),
    APT(SP_DUGONG_OVERLORD,    SK_DODGING,         6),
    APT(SP_DUGONG_OVERLORD,    SK_STEALTH,         3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DUGONG_OVERLORD,    SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_DUGONG_OVERLORD,    SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DUGONG_OVERLORD,    SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_DUGONG_OVERLORD,    SK_UNARMED_COMBAT,  6),
    APT(SP_DUGONG_OVERLORD,    SK_SPELLCASTING,    2),
    APT(SP_DUGONG_OVERLORD,    SK_CONJURATIONS,    2),
    APT(SP_DUGONG_OVERLORD,    SK_HEXES,           2),
    APT(SP_DUGONG_OVERLORD,    SK_CHARMS,          2),
    APT(SP_DUGONG_OVERLORD,    SK_SUMMONINGS,      4),
    APT(SP_DUGONG_OVERLORD,    SK_NECROMANCY,      2),
    APT(SP_DUGONG_OVERLORD,    SK_TRANSLOCATIONS,  1),
    APT(SP_DUGONG_OVERLORD,    SK_TRANSMUTATIONS,  1),
    APT(SP_DUGONG_OVERLORD,    SK_FIRE_MAGIC,     -4),
    APT(SP_DUGONG_OVERLORD,    SK_ICE_MAGIC,       6),
    APT(SP_DUGONG_OVERLORD,    SK_AIR_MAGIC,       4),
    APT(SP_DUGONG_OVERLORD,    SK_EARTH_MAGIC,     4),
    APT(SP_DUGONG_OVERLORD,    SK_POISON_MAGIC,    4),
    APT(SP_DUGONG_OVERLORD,    SK_INVOCATIONS,     2),
    APT(SP_DUGONG_OVERLORD,    SK_EVOCATIONS,      2),
};
